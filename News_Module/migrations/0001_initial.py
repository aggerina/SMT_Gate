    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text_fa', models.TextField(null=True, verbose_name='Text')),
                ('text_en', models.TextField(null=True, verbose_name='Text')),
                ('News', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='News_Module.news', verbose_name='News')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='News_Module.newscomment', verbose_name='Parent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='News_Module.newscategory', verbose_name='Parent')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='News_Module.newscategory', verbose_name='Choices category'),
        ),
    ]
